...
with open("src/data/Fold_data/data_path_all_efficient.csv","w") as csvfile:
    contents = []
...
#     for DIR_ in ['train.txt']:
        ...
        with open(DIR_) as f:
            ...
            line = f.readline().rstrip('\n').replace('tagging/tagging_dataset_train_5k', 'train').replace('Youtube8M/tagging', 'efficient')
            while line:
                line_data = []
                # video
