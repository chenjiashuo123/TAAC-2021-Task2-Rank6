...
with open("src/data/Fold_data/data_path_test_2nd_400_efficient.csv","w") as csvfile:
    contents = []
...
#     for DIR_ in ['train.txt']:
        ...
        with open(DIR_) as f:
            ...
            line = f.readline().rstrip('\n').replace('tagging/tagging_dataset_test_5k_2nd', 'test_2nd').replace('Youtube8M/tagging', 'efficient')
            while line:
                line_data = []
                # video
